...
# ./init.sh
# ./init.sh africa
# ./init.sh africa geofabrik
# ./init.sh africa osmfr
# ./init.sh alabama
# ./init.sh alaska
# ./init.sh albania
# ./init.sh alberta
# ./init.sh alps
# ./init.sh europe/austria
# ./init.sh europe/austria/salzburg osmfr
# ./init.sh Adelaide
# ./init.sh Adelaide bbbike
# ....
#
...
if [ $# -eq 0 ]; then
  # IOBT:  CHANGE AREA HERE
  # geofabik areas for US can be found here:  http://download.geofabrik.de/north-america/us.html (use hyphens for states consisting of two words)
  export area=north-carolina
...
echo " "
echo "-------------------------------------------------------------------------------------"
echo "The ./init.sh $area  is finished! "
